...
import useGetAllOrder from "../hooks/orders/useGetAllOrder";
...
import useGetFeaturedProduct from "../hooks/orders/useGetFeaturedProduct";
...
const FeaturedProduct = () => {
  ...
  const { loading: loadingOrders, orders,totalData:ordertotalData } = useGetAllOrder({
    filters: apiFilters,
    search: searchTerm,
    page: currentPage,
    limit: pageSize,
  });
  const { loading: loadingFeatured, featuredProduct,totalData:FeaturedProdData } = useGetFeaturedProduct({
    filters: apiFilters,
    search: searchTerm,
    page: currentPage,
    limit: pageSize,
...
console.log(FeaturedProdData,"FeaturedProdData")
  const productStats = useMemo(
    () => [
      {
        title: "Total Subcriptions",
        value: FeaturedProdData,
        icon: Package,
...
const handleFeaturedExport = (purchases) => {
  return purchases.map((item) => ({
    ...
    Type: item.type,
    Amount: item.amount,
    "Target Product": item.targetProduct?.name,
    "Purchased At": formatDate(item.purchasedAt),
